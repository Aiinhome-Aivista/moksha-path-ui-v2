    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="grid grid-cols-1 gap-4">
        <div className="grid grid-cols-2 gap-4 row-span-2">
          <div className="bg-white p-4 rounded-xl shadow border-[#7BA6B3] border-b-4">
        ...
        <div className="bg-gray-800 text-white p-4 rounded-xl w-full">
          {/* Title */}
      ...
      <div className="grid grid-cols-1 grid-rows-3 gap-4">
        <div className="bg-white p-4 rounded-xl shadow col-span-2">
          <h3 className="font-semibold mb-3">
            Time Distribution by Difficulty2
          </h3>
        ...
        <div className=" grid grid-cols-3 gap-4 row-span-2 bg-white p-4 rounded-xl shadow">
          <div>
          ...
          <div className="col-span-2">
            <ul className="text-sm text-gray-600 space-y-1 pt-12">
              <li>
                ✔ You constantly clear L1 & L2 questions but lose accuracy at
                L3.
              </li>
              <li>
                ✔ The engine is routine towards L3 more frequently this is where
                your biggest score gains lie.
              </li>
            </ul>
            <p className="mt-2 text-xs text-gray-400">
              If you crack 13 consistently you'll reach
            </p>
            <h2 className="mt-2 text-xs text-black">
              <span className="text-2xl font-bold"> Top 8%</span> School
              Percentile
            </h2>
          </div>
        </div>
