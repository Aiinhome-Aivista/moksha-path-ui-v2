  ...
  const { data, totalSubjects } = React.useMemo(() => {
    ...
    if (selectedSubject) {
      ...
      if (currentSubject && currentSubject.chapters) {
        ...
        return { data: formattedChapters, totalSubjects: currentSubject.chapters.length };
      } else {
        return { data: [], totalSubjects: 0 };
      }
    } else {
      ...
      return { data: formattedSubjects, totalSubjects: totalSubjectsCount };
    }
