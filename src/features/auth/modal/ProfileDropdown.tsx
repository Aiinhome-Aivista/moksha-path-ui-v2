    ...
    <>
      ...
      {isOpen && (
        <div
          ...
          className="absolute -top-2 xl:-left-20 2xl:-left-12 w-[273px] bg-white rounded-b-[24px] shadow-[0_10px_40px_rgba(0,0,0,0.15)] z-[9999] animate-in fade-in slide-in-from-top-5 duration-200 font-['Montserrat'] flex flex-col"
        >
