...
import MaterialsSidebar from "../components/TutorMaterialSidebar";
import MaterialsHeader from "../components/TutorMaterialHeader";
import ResourceMaterials, {
  type YouTubeLink,
} from "../components/TutorMaterialVideos";
import Tests from "../components/TutorTestAssignPage";
import Notes, { type NoteData } from "../components/TutorMaterialNotes";
...
const TutorMaterials = () => {
  ...
  useEffect(() => {
    if (location.pathname.includes("private-tutor/videos")) {
      setActiveResourceType("Videos");
    } else if (location.pathname.includes("private-tutor/tests")) {
      setActiveResourceType("Tests");
    } else if (location.pathname.includes("private-tutor/notes")) {
